...
h_ele = ROOT.TH1D('ele_mvaEleID-Fall17-noIso-V2-wp80', 'mvaEleID-Fall17-noIso-V2-wp80_value', 20, 0., 1.,)
    ...
    if not done_ele:
        ...
        for ele_nr,ele in enumerate(eles.product()):
            if ele.et()<min_ele_et: continue
                ...
                h_ele.Fill(ele.userFloat('mvaEleID-Fall17-noIso-V2-wp80_value'))
                done_ele = True
